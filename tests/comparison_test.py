...
plt.subplot(2,1,1)
plt.plot(traj_cost_hist_2, label='iSCvx')
plt.plot(traj_cost_hist_1, label='SCvx')
plt.grid()
...
plt.subplot(2,1,2)
plt.semilogy(penalty_hist_2, label='iSCvx')
plt.semilogy(penalty_hist_1, label='SCvx')
plt.grid()
plt.xlabel("iteration")
plt.ylabel("penalty")
